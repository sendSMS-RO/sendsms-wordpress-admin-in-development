<div class="wrap">
    <div class="sendsms-container">
        ...
        <div class="sendsms-containter-grid-test">
            <span class="sendsms-item-input-1" id="forPhoneNumber" data-bs-toggle="tooltip" data-placement="top" title="<?= __('We recommend a phone number in E.164 Format but without the + sign', 'sendsms-dashboard') ?>"><?= __('Phone number', 'sendsms-dashboard') ?></span>
            ...
            <span class="sendsms-item-input-1" id="forFrom" data-bs-toggle="tooltip" data-placement="top" title="<?= __('Your SendSMS Label', 'sendsms-dashboard') ?>"><?= __('From', 'sendsms-dashboard') ?></span>
            <input id="label" type="text" class="sendsms-item-input-1" value="1898" aria-label="Label" aria-describedby="forLabel">

            <span id="forGdpr" class="sendsms-item-input-1" data-bs-toggle="tooltip" data-placement="top" title="<?= __('You must specify {gdpr} key message. {gdpr} key will be replaced automaticaly with confirmation unique confirmation link. If {gdpr} key is not specified confirmation link will be placed at the end of message.', 'sendsms-dashboard') ?>"><?= __('Unsubscribe link?', 'sendsms-dashboard') ?></span>
            <input id="gdpr" class="sendsms-item-input-1" type="checkbox" value="gdrp" aria-label="Unsubscribe Link" aria-describedby="forGdpr">
            <span id="forShort" class="sendsms-item-input-1" data-bs-toggle="tooltip" data-placement="top" title="<?= __('Searches long url and replaces them with coresponding sort url', 'sendsms-dashboard') ?>"><?= __('Shrink urls?', 'sendsms-dashboard') ?></span>
            <input id="short" class="sendsms-item-input-1" type="checkbox" value="short" aria-label="Shrink urls?" aria-describedby="forShort">

            <span class="sendsms-item-input-1" id="forMessage" data-bs-toggle="tooltip" data-placement="top" title="<?= __('The message you want to send', 'sendsms-dashboard') ?>"><?= __('Message', 'sendsms-dashboard') ?></span>
