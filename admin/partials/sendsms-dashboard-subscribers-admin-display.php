...
<div class="wrap">
	...
	<button type="submit" class="" id="sendsms-dashboard-subscribers-add-new"><?php echo __( 'Add new', 'sendsms-dashboard' ); ?></button>
	<button type="submit" class="" id="sendsms-dashboard-subscribers-synchronize"><?php echo __( 'Synchronize subscribers', 'sendsms-dashboard' ); ?></button>
