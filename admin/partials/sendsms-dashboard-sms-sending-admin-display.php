    ...
    <div class="sendsms-container">
        ...
        <div class="sendsms-container-grid-test">
            ...
            <div class="sendsms-item-input-1">
                ...
                <i class="fas fa-question-circle tooltip" data-title="<?php echo __('You must specify {gdpr} key message. {gdpr} key will be replaced automatically with confirmation unique confirmation link. If {gdpr} key is not specified confirmation link will be placed at the end of message.', 'sendsms-dashboard') ?>"></i>
            </div>
            ...
            <div class="sendsms-item-input-1">
                ...
                <i class="fas fa-question-circle tooltip" data-title="<?php echo __('Searches long url and replaces them with corresponding short url. Please use only urls that start with https:// or http://', 'sendsms-dashboard') ?>"></i>
            </div>
