...
class Sendsms_Dashboard
{
	...
	private function load_dependencies()
	{
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-sendsms-dashboard-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-sendsms-dashboard-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-sendsms-dashboard-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-sendsms-dashboard-public.php';
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action('wp_ajax_edit_a_subscriber', $plugin_admin, 'edit_a_subscriber');
		//load phone fields
